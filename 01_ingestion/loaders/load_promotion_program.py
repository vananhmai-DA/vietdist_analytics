...
SOURCE_FILE = PROJECT_ROOT / "data" / "raw" / "SRC10_promotion_program.xlsx"
...
def read_all_sheets(file_path: Path) -> pd.DataFrame:
    """
    Read all sheets from promotion_program Excel file.
    Each sheet represents one promotion program.
    """
...
def run():
    ...
    try:
        ...
        current_step = "PARSE_ALL_SHEETS"
        df = read_all_sheets(SOURCE_FILE)
